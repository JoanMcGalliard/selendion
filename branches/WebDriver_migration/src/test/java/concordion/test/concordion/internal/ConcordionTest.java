...
import concordion.test.concordion.StubSource;
import concordion.test.concordion.StubTarget;
...
public class ConcordionTest {
	...
	public void testProcessFixtureIsNull() throws IOException {
		Concordion concordion = new SelendionBuilder().build();
		Object fixture = null;
		try {
	...
	public void testResourceFromFixtureClassName() throws IOException {
		...
		String resourceName = "/concordion/test/concordion/internal/ConcordionTest$EmptyFixture.html";
	...
	public void testResourcesWithLinks() throws IOException {
		...
		String resourceName_S1 = "/concordion/test/concordion/internal/ConcordionTest$EmptyFixture_S1.html";
	...
	private Concordion createConcordion(StubSource source, StubTarget target) {
		return new SelendionBuilder().withTarget(target).withSource(source)
				.build();
	}

	private void addDocumentToSource(String fileName, String resourceName) throws IOException {
		String document = IOUtil.readResourceAsString("/concordion/test/concordion/internal/" + fileName);
